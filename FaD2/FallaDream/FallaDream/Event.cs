...
namespace FallaDream
{
    class Event
    {
        ...
        public void setEvent(int _no) 
        {
           ...
           new System.IO.StreamReader("story/FaDstage" + _no + ".txt", System.Text.Encoding.Default)
       );
        ...
        public void setBGI(int i)
        {
            ...
            Stream stream = File.OpenRead("images/hb1.png");
            imgBGI = Texture2D.FromStream(g, stream);
        ...
        {
            //ワープの効果
            Stream stream = File.OpenRead("images/pikaan.png");
            imgBGI = Texture2D.FromStream(g, stream);
            name = "";
            talk = "ピカーーーン！！！";
        ...
        public void setIN(string[] com)
        {
            if (com[1].Equals("L"))
            {
                ...
                leftFlg0 = true;
                Stream stream1 = File.OpenRead("images/" + com[2] + ".png");
                ...
                if (com.Length > 3)
                {
                    ...
                    leftFlg1 = true;
                     Stream stream2 = File.OpenRead("images/" + com[3] +  ".png");
